...
var JPortfolioService = Java.type('io.vertx.workshop.portfolio.PortfolioService');
var Portfolio = Java.type('io.vertx.workshop.portfolio.Portfolio');
...
var PortfolioService = function(j_val) {
  ...
  var __super_getPortfolio = this.getPortfolio;
  var __super_buy = this.buy;
  var __super_sell = this.sell;
  var __super_evaluate = this.evaluate;
  /**
   Gets the portfolio.
  ...
  this.getPortfolio =  function(resultHandler) {
    ...
    } else if (typeof __super_getPortfolio != 'undefined') {
      return __super_getPortfolio.apply(this, __args);
    }
  ...
  this.buy =  function(amount, quote, resultHandler) {
    ...
    if (__args.length === 3 && typeof __args[0] ==='number' && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
      j_portfolioService["buy(int,io.vertx.core.json.JsonObject,io.vertx.core.Handler)"](__args[0], utils.convParamJsonObject(__args[1]), function(ar) {
        if (ar.succeeded()) {
    ...
    } else if (typeof __super_buy != 'undefined') {
      return __super_buy.apply(this, __args);
    }
    else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.sell =  function(amount, quote, resultHandler) {
    var __args = arguments;
    if (__args.length === 3 && typeof __args[0] ==='number' && (typeof __args[1] === 'object' && __args[1] != null) && typeof __args[2] === 'function') {
      j_portfolioService["sell(int,io.vertx.core.json.JsonObject,io.vertx.core.Handler)"](__args[0], utils.convParamJsonObject(__args[1]), function(ar) {
        if (ar.succeeded()) {
          __args[2](utils.convReturnDataObject(ar.result()), null);
        } else {
          __args[2](null, ar.cause());
    ...
    } else if (typeof __super_sell != 'undefined') {
      return __super_sell.apply(this, __args);
    }
    else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.evaluate =  function(resultHandler) {
    ...
    } else if (typeof __super_evaluate != 'undefined') {
      return __super_evaluate.apply(this, __args);
    }
    else throw new TypeError('function invoked with invalid arguments');
  };
...
PortfolioService._jclass = utils.getJavaClass("io.vertx.workshop.portfolio.PortfolioService");
PortfolioService._jtype = {accept: function(obj) {
    return PortfolioService._jclass.isInstance(obj._jdel);
  },wrap: function(jdel) {
    var obj = Object.create(PortfolioService.prototype, {});
    PortfolioService.apply(obj, arguments);
    return obj;
  },
  unwrap: function(obj) {
    return obj._jdel;
...
PortfolioService._create = function(jdel) {var obj = Object.create(PortfolioService.prototype, {});
  PortfolioService.apply(obj, arguments);
  return obj;
}
PortfolioService.ADDRESS = JPortfolioService.ADDRESS;
PortfolioService.EVENT_ADDRESS = JPortfolioService.EVENT_ADDRESS;
